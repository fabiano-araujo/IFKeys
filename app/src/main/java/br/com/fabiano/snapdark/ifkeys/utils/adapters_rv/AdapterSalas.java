 ...
 */
public class AdapterSalas extends RecyclerView.Adapter<AdapterSalas.MyViewHolder> implements FastScrollRecyclerView.SectionedAdapter {
    private LayoutInflater mLayoutInflater;
    private Activity mContext;
    public boolean playlist = false;
    private List<Sala> salas;
    public AdapterSalas(Activity mContext, List<Sala> salas) {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup viewGroup, int viewType) {
        View view = mLayoutInflater.inflate(R.layout.item_sala, viewGroup, false);
    ...
    public void onBindViewHolder(final MyViewHolder myViewHolder, final int position) {
        ...
        //setOnLongClick(position,myViewHolder.view,sala);
    }
    ...
    public void add(int position,Sala sala){
        salas.add(position, sala);
    ...
    public String getSectionName(int position) {
        String show = "#";
        try{
            show = salas.get(position).nome.substring(0, 1);
